...
# Default-Start:     S
# Default-Stop:      
# Short-Description: iBox Nano Node JS
# Description:       iBox Nano Node JS Control Interfac
### END INIT INFO
#
# Based on:
...
NODE_BIN_DIR="/usr/local/node/bin"
NODE_PATH="/usr/local/lib/node_modules"
APPLICATION_PATH="/home/pi/ibox/iBoxWebGUI.js"
PIDFILE="/var/run/iBoxWebGUI.pid"
LOGFILE="/home/pi/ibox/logs/iBoxWebGUI_Forever.log"
MIN_UPTIME="5000"
SPIN_SLEEP_TIME="2000"
...
    # running.
    #
    # Note that redirecting the output to slashdevslashnull or anywhere is necessary
    # to make this script work if provisioning the service via Chef.
    #forever --pidFile /var/run/iBoxWebGUI.pid -a -l /home/pi/ibox/logs/iBoxWebGUI_Forever.log --minUptime 5000 --spinSleepTime 2000 start /home/pi/ibox/iBoxWebGUI.js 2>&1 > /dev/null &RETVAL=$?
    forever \
      --pidFile $PIDFILE \
      -a \
      -l $LOGFILE \
